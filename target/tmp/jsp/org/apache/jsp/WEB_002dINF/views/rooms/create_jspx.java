...
public final class create_jspx extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_form_create_0(PageContext _jspx_page_context)
    ...
    _jspx_th_form_create_0.setZ("y6goS2KU+ZqRZvGeKMimwdOkGA8=");
    ...
    _jspx_th_form_create_0.setPath("/rooms");
    _jspx_th_form_create_0.setModelAttribute("room");
    _jspx_th_form_create_0.setId("fc_com_se_reservationsystem_domain_Room");
  ...
  private boolean _jspx_meth_field_input_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_input_0.setZ("Zx9Wy6+U5fa/iW0eXOX3EkiORVg=");
    _jspx_th_field_input_0.setRequired(new Boolean(true));
    _jspx_th_field_input_0.setId("c_com_se_reservationsystem_domain_Room_roomNumber");
    _jspx_th_field_input_0.setField("roomNumber");
  ...
  private boolean _jspx_meth_field_select_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_select_0.setZ("mnCdShxiKbLqPtSD0VdXk/pCbJA=");
    _jspx_th_field_select_0.setPath("/roomtypes");
    _jspx_th_field_select_0.setItems((java.util.Collection) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${roomtypes}", java.util.Collection.class, (PageContext)_jspx_page_context, null));
    _jspx_th_field_select_0.setItemValue("id");
    _jspx_th_field_select_0.setId("c_com_se_reservationsystem_domain_Room_roomType");
    _jspx_th_field_select_0.setField("roomType");
  ...
  private boolean _jspx_meth_field_select_1(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_select_1.setZ("oMYJfnRVkOViALV/cLAZ7o+l0lA=");
    _jspx_th_field_select_1.setPath("roomstatuses");
    _jspx_th_field_select_1.setItems((java.util.Collection) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${roomstatuses}", java.util.Collection.class, (PageContext)_jspx_page_context, null));
    _jspx_th_field_select_1.setId("c_com_se_reservationsystem_domain_Room_status");
    _jspx_th_field_select_1.setField("status");
  ...
  private boolean _jspx_meth_form_dependency_0(PageContext _jspx_page_context)
    ...
    _jspx_th_form_dependency_0.setZ("LXh3f7/4trpOfyFuFiYlgkoGags=");
    ...
    _jspx_th_form_dependency_0.setId("d_com_se_reservationsystem_domain_Room");
