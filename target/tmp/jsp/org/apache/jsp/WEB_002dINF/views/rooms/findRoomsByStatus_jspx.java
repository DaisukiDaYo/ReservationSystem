...
public final class findRoomsByStatus_jspx extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_form_find_0(PageContext _jspx_page_context)
    ...
    _jspx_th_form_find_0.setZ("AfLJEBuZ4yhqcpEGNK6IxIe92aI=");
    _jspx_th_form_find_0.setPath("/rooms");
    _jspx_th_form_find_0.setId("ff_com_se_reservationsystem_domain_Room");
    _jspx_th_form_find_0.setFinderName("ByStatus");
    _jspx_th_form_find_0.setJspBody(new findRoomsByStatus_jspxHelper( 0, _jspx_page_context, _jspx_th_form_find_0, null));
  ...
  private boolean _jspx_meth_field_select_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_field_select_0.setZ("K1Ko0EshqkIUz5VEWRyLquUYDK8=");
    _jspx_th_field_select_0.setRequired(new Boolean(true));
    _jspx_th_field_select_0.setPath("/roomstatuses");
    _jspx_th_field_select_0.setItems((java.util.Collection) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${roomstatuses}", java.util.Collection.class, (PageContext)_jspx_page_context, null));
    _jspx_th_field_select_0.setId("f_com_se_reservationsystem_domain_Room_status");
    _jspx_th_field_select_0.setField("status");
    _jspx_th_field_select_0.setDisableFormBinding(new Boolean(true));
    _jspx_th_field_select_0.doTag();
    return false;
  }

  private class findRoomsByStatus_jspxHelper
      extends org.apache.jasper.runtime.JspFragmentHelper
  {
    private javax.servlet.jsp.tagext.JspTag _jspx_parent;
    private int[] _jspx_push_body_count;

    public findRoomsByStatus_jspxHelper( int discriminator, JspContext jspContext, javax.servlet.jsp.tagext.JspTag _jspx_parent, int[] _jspx_push_body_count ) {
