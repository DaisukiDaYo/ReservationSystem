...
public final class list_jspx extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_page_list_0(PageContext _jspx_page_context)
    ...
    _jspx_th_page_list_0.setZ("mkOM3DM7jOjrRHEjr2zXUXVD+uE=");
    _jspx_th_page_list_0.setItems((java.util.Collection) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${rooms}", java.util.Collection.class, (PageContext)_jspx_page_context, null));
    _jspx_th_page_list_0.setId("pl_com_se_reservationsystem_domain_Room");
  ...
  private boolean _jspx_meth_table_table_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_table_0.setZ("v02OzCfR2jmj1vL1+GiRWNOfNUs=");
    _jspx_th_table_table_0.setPath("/rooms");
    _jspx_th_table_table_0.setId("l_com_se_reservationsystem_domain_Room");
    _jspx_th_table_table_0.setData((java.util.Collection) org.apache.jasper.runtime.PageContextImpl.evaluateExpression("${rooms}", java.util.Collection.class, (PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_table_column_0(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_column_0.setZ("99FQ2w90/KSHL7QfMYyDy7JDIgQ=");
    _jspx_th_table_column_0.setProperty("roomNumber");
    _jspx_th_table_column_0.setId("c_com_se_reservationsystem_domain_Room_roomNumber");
  ...
  private boolean _jspx_meth_table_column_1(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_column_1.setZ("Bo50DvApcvjaKvFbKIf3oQv3O88=");
    _jspx_th_table_column_1.setProperty("roomType");
    _jspx_th_table_column_1.setId("c_com_se_reservationsystem_domain_Room_roomType");
  ...
  private boolean _jspx_meth_table_column_2(javax.servlet.jsp.tagext.JspTag _jspx_parent, PageContext _jspx_page_context)
    ...
    _jspx_th_table_column_2.setZ("maefJOMtnAFJBTO0Qeq3MiXY65g=");
    _jspx_th_table_column_2.setProperty("status");
    _jspx_th_table_column_2.setId("c_com_se_reservationsystem_domain_Room_status");
